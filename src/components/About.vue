<template>
  <div class="container is-widescreen">
    <section class="content column fadeIn">
      ...
      <p><a id="colaborate" class="button is-success is-rounded" href="mailto:overlemonsoft@gmail.com?Subject=Hi, I want to be part of Biltz">I want to be part of Biltz</a></p>
      <br>
      <p>Thank you for your visit, and watch your Queen!</p>
    </section>
  </div>
</template>
